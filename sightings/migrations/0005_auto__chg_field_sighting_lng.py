...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sighting.lng'
        db.alter_column(u'sightings_sighting', 'lng', self.gf('django.db.models.fields.DecimalField')(max_digits=23, decimal_places=20))

    def backwards(self, orm):

        # Changing field 'Sighting.lng'
        db.alter_column(u'sightings_sighting', 'lng', self.gf('django.db.models.fields.DecimalField')(max_digits=22, decimal_places=20))
