...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sighting.thumb'
        db.add_column(u'sightings_sighting', 'thumb',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=3000, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Sighting.image'
        db.alter_column(u'sightings_sighting', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=3000, null=True))

    def backwards(self, orm):
        # Deleting field 'Sighting.thumb'
        db.delete_column(u'sightings_sighting', 'thumb')


        # Changing field 'Sighting.image'
        db.alter_column(u'sightings_sighting', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=3000, null=True))
