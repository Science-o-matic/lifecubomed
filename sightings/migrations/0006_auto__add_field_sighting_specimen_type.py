...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sighting.specimen_type'
        db.add_column(u'sightings_sighting', 'specimen_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sighting.specimen_type'
        db.delete_column(u'sightings_sighting', 'specimen_type')
