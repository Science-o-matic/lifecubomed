...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sighting.address'
        db.alter_column(u'sightings_sighting', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=5000))

    def backwards(self, orm):

        # Changing field 'Sighting.address'
        db.alter_column(u'sightings_sighting', 'address', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))
