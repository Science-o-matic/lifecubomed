...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sighting.description_extra'
        db.delete_column(u'sightings_sighting', 'description_extra')

        # Adding field 'Sighting.other_specimen_description'
        db.add_column(u'sightings_sighting', 'other_specimen_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sighting.description_extra'
        db.add_column(u'sightings_sighting', 'description_extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Sighting.other_specimen_description'
        db.delete_column(u'sightings_sighting', 'other_specimen_description')
